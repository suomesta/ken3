...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(ten, array)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(array, ten)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(p, array)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(array, p)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(array, dummy)) {
        i.first += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(dummy, array)) {
        i.second += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(v, dummy)) {
        i.first += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(dummy, v)) {
        i.second += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(s, dummy)) {
        i.first += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::zip(dummy, s)) {
        i.second += 1;
    }
