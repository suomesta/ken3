...
int test_func(void)
{
    ...
    for (auto i: ken3::py::enumerate(ten)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::enumerate(e)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::enumerate(p)) {
        ;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::enumerate(array)) {
        i.second += 1;
    }
...
int test_func(void)
{
    ...
    for (auto i: ken3::py::enumerate(s)) {
        i.second += 1;
    }
