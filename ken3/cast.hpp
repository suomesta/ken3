...
TO int_cast(FROM i)
{
    ...
    using my_factory = int_cast_detail::factory<int_cast_detail::factory_index<TO, FROM>()>;
    return int_cast_detail::int_cast<TO, FROM>(i, my_factory{});
}
/////////////////////////////////////////////////////////////////////////////
